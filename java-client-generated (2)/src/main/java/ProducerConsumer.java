...
public class ProducerConsumer {
    public static final String BASE_URL = "http://localhost:8080/maven_war_exploded";
    ...
    public static void main(String[] args) throws Exception{
       ...
       // start phase 1
        ...
        Phase phase1 = new Phase("phase1", 32, skiersApi, queue, phaseTwoCount, csvWriter, globalQueue, successCount, failCount);
        phase1.startPhase();
        ...
        Phase phase2 = new Phase("phase2", 168, skiersApi, queue, phaseThreeCountDown, csvWriter,globalQueue, successCount, failCount);
        phase2.startPhase();
